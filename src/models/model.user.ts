...
export class User {
    ...
    public readonly timezone: string; // IANA timezone, e.g. "Asia/Kolkata"
    ...
    private constructor(params: {
        ...
        this.timezone = params.timezone || 'UNSET';
    ...
    static fromTelegram(tgUser: BotUser, internalId: string, timezone?: string): User {
        return new User({
